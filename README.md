...
To find the location of the stops, a PostgreSQL query was used to find the most common coordinates of the buses, which was cross referenced with the PassioGo map to eliminate any non-stops (intersections, crosswalks, etc.). This is shown in the “Identify Silver Route Stops” sheet. 
